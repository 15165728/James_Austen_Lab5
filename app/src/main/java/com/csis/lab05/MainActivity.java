...
public class MainActivity extends AppCompatActivity implements SensorEventListener, LocationListener {//must declare this to use later, used to receive data from sendEvents
